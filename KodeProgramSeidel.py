...
def seidel(x0,y0,tol=1e-6,maxit=200):
    x, y = x0, y0
    print(f"{'Iter':<6}{'x':>14}{'y':>14}{'rx':>12}{'ry':>12}")
    ...
    for k in range(1, maxit+1):
        ...
        ry = abs(y_new - y)
        x, y = x_new, y_new
        print(f"{k:<6}{x:14.9f}{y:14.9f}{rx:12.6e}{ry:12.6e}")
...
if __name__ == '__main__':
    print('Running Gauss-Seidel (g1B & g2B)')
    sol = seidel(1.5,3.5)
    print('\nResult:', sol)
